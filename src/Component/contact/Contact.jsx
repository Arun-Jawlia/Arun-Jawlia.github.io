...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_6uiryl8', 'template_gd2squp', form.current, '21KymLPRnAuY26ycj')
      e.target.reset()
    };
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              ...
              <span className="contact_card_data">arunkumar08.mk@gmail.com</span>
              <a href="mailto:arunkumar08.mk@gmail.com" className="contact_button" target='blank'>
                Write me
            ...
            <div className="contact_card">
              ...
              <a href='https://web.whatsapp.com/' className="contact_button" target='blank'>
                Write me
                <i className="bx bx-right-arrow-alt contact_button_icon"></i>
              </a>
            </div>
            ...
            <div className="contact_card">
              ...
              <a href="https://www.linkedin.com/in/arun-jawlia-0a262022b/"  className="contact_button">
                Write me
                <i className="bx bx-right-arrow-alt contact_button_icon"></i>
              </a>
            </div>
        ...
        <div className="contact_content">
          ...
          <form ref={form} onSubmit={sendEmail}   className="contact_form">
            ...
            <div className="contact_form_div contact_form_area">
                ...
                <textarea name="message" cols="30" rows="10" className="contact_form_input" placeholder="Enter your message" ></textarea>
